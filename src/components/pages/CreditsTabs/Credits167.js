...
// CORREÇÃO: Aponta para o mesmo CSS unificado para herdar o layout perfeito e idêntico da aba 160
        ...
        fetch('http://localhost:5000/credits_nc')
            ...
            .then(data => {
                if (Array.isArray(data)) {
                    // Filtra os registros pertencentes à Fonte de Recurso 167
                    const apenasFR167 = data.filter(item => item.fonteRecurso === '167');
                    setListaNCs(apenasFR167);
                }
            })
